...
<html>
<head>
	<title>TicketReady :: Login</title>
	<link rel="shortcut icon" href="images/logowobg.ico"></link>
	<meta charset="utf-8">
...
<body>
	...
	<div class="wrap">
		...
		<div  class=" well login">
			...
			<tr>
			<td colspan=2 style="border-top:0px; visibility:hidden;" id="wrong"  class="label label-important">Username and Password not Matching!</td>
			</tr>
			<tr>
